...
namespace CP2.Controllers
{
    public class PostagemController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,Conteudo,DataPublicacao")] Postagem postagem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,Conteudo,DataPublicacao")] Postagem postagem)
        {
            if (id != postagem.Id)
            {
                return NotFound();
